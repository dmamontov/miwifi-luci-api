...
function L7()
  ...
  L5 = L1
  L3, L4, L5, L6, L7, L8, L9, L10, L11 = L3(L4, L5)
  ...
  L6 = -5
  L7 = -2
  L4, L5, L6, L7, L8, L9, L10, L11 = L4(L5, L6, L7)
...
function L7()
  ...
  if L5 == 1 then
    ...
    L7 = string
    L7 = L7.format
    L8 = "matool --method api_call --params /device/wifi_rent/enable_wechat_pay \"{\\\"password\\\":\\\"%s\\\",\\\"ssid\\\":\\\"%s\\\",\\\"encryption\\\":\\\"none\\\"}\""
    L9 = L6
    L10 = L5
    L7 = L7(L8, L9, L10)
    L8 = _UPVALUE2_
    ...
    if L9 then
      ...
      if L11 == 0 then
        L3.msg = "success."
        L11 = L10.is_router_bound
        L3.is_router_bound = L11
    end
    else
      L11 = L10.code
      L3.code = L11
