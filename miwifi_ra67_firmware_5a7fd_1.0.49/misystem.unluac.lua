...
function L10()
  ...
  if L16 == 0 then
    ...
    if L16 == 0 then
      ...
      L18 = string
      L18 = L18.format
      L19 = "/usr/sbin/mesh_connect.sh init_cap"
...
function L10()
  ...
  L20 = L20.formvalue
  L21 = "initialize"
  L20, L21, L22, L23, L24, L25, L26, L27, L28, L29, L30, L31, L32, L33, L34, L35, L36, L37 = L20(L21)
  L19 = L19(L20, L21, L22, L23, L24, L25, L26, L27, L28, L29, L30, L31, L32, L33, L34, L35, L36, L37)
  if L19 == 1 then
    L19 = 1
    if L19 then
      goto lbl_83
  ...
  L25 = L25.formvalue
  L26 = "txpwr"
  L25, L26, L27, L28, L29, L30, L31, L32, L33, L34, L35, L36, L37 = L25(L26)
  L24 = L24(L25, L26, L27, L28, L29, L30, L31, L32, L33, L34, L35, L36, L37)
  L24 = L24 or L24
  L25 = L4.nvramSet
  ...
  if L25 == 0 and L7 then
    ...
    L36 = L18
    L37 = L16
    L26 = L26(L27, L28, L29, L30, L31, L32, L33, L34, L35, L36, L37)
    L25 = L26
    L26 = L25.scan
    if not L26 then
      L6.code = 1617
...
function L10()
  ...
  if L4 ~= 0 then
    ...
    if L2 then
      L5 = L4.forkExec
      L6 = "/etc/init.d/qca-nss-ecm stop"
      L5(L6)
      L5 = os
      L5 = L5.execute
      L6 = "sleep 1"
      ...
      L5(L6)
      L5 = L4.forkExec
      L6 = "/etc/init.d/qca-nss-ecm start"
      L5(L6)
    end
    ::lbl_65::
    L4 = require
