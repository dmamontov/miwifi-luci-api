...
function L0()
  ...
  L3 = "api"
  L4 = "xqsystem"
  L5 = "oneclick_get_remote_token"
  L2[1] = L3
  L2[2] = L4
  L2[3] = L5
  L3 = call
  L4 = "oneClickGetRemoteToken"
  L3 = L3(L4)
  L4 = ""
  L5 = 209
  L6 = 8
  ...
  L3 = "api"
  L4 = "xqsystem"
  L5 = "extendwifi_request_remote_api"
  L2[1] = L3
  L2[2] = L4
  L2[3] = L5
  L3 = call
  L4 = "ExtendWifiRequestRemoteAPI"
  L3 = L3(L4)
  L4 = ""
  L5 = 210
  L6 = 8
  ...
  L3 = "api"
  L4 = "xqsystem"
  L5 = "extendwifi_get_root_dir_info"
  L2[1] = L3
  L2[2] = L4
  L2[3] = L5
  L3 = call
  L4 = "ExtendWifiGetRootDirInfo"
  L3 = L3(L4)
  L4 = ""
  L5 = 211
  L6 = 8
  ...
  L3 = "api"
  L4 = "xqsystem"
  L5 = "extendwifi_get_root_dir_useage"
  L2[1] = L3
  L2[2] = L4
  L2[3] = L5
  L3 = call
  L4 = "ExtendWifiGetRootDirUseage"
  L3 = L3(L4)
  L4 = ""
  L5 = 212
  L6 = 8
  ...
  L3 = "api"
  L4 = "xqsystem"
  L5 = "extendwifi_connect_inited_router"
  L2[1] = L3
  L2[2] = L4
  L2[3] = L5
  L3 = call
  L4 = "ExtendWifiConnectInitedRouter"
  L3 = L3(L4)
  L4 = ""
  L5 = 214
  L6 = 8
  ...
  L3 = "api"
  L4 = "xqsystem"
  L5 = "extendwifi_sign_for_auto_band"
  L2[1] = L3
  L2[2] = L4
  L2[3] = L5
  L3 = call
  L4 = "ExtendWifiSignForAutoBand"
  L3 = L3(L4)
  L4 = ""
  L5 = 215
  L6 = 9
...
function L4()
  ...
  L7 = L7()
  L6.romversion = L7
  L7 = L2.getModulesList
  L7 = L7()
  L6.modules = L7
  L7 = L2.getLang
  L7 = L7()
  L6.language = L7
  L7 = L0.getCurrentCountryCode
  L7 = L7()
  L6.countrycode = L7
  L7 = L2.getRouterName
  L7 = L7()
...
function L4()
  ...
  L3 = {}
  L4 = L1.exec
  L5 = "ubus call trafficd bind"
  L4(L5)
  L4 = L0.log
  L5 = 6
  L6 = "luci call bind ok... "
  L4(L5, L6)
  L3.code = L2
  L4 = _UPVALUE0_
  L4 = L4.write_json
...
function L4()
  ...
  if L10 then
    ...
    L10 = L10(L11, L12)
    if L10 then
      L10 = L2.generateLogKeyV2
      L10 = L10()
      L11 = L4.log
      L12 = 6
      L13 = "D01 CAP call RE upload log, CAP key:"
      L14 = L10
      L13 = L13 .. L14
      L11(L12, L13)
      L11 = L0.forkExec
      L12 = "/sbin/whc_to_re_common_api.sh log_upload "
      L13 = L10
      L12 = L12 .. L13
      L11(L12)
    end
  ...
  L10 = L3.exec
  L11 = "/usr/sbin/log_collection.sh"
  L10(L11)
  L10 = L2.uploadLogV2
  L10 = L10()
  if not L10 then
...
function L4()
  ...
  L5 = 0
  L6 = {}
  L7 = L0.FORK_RESET_ALL
  if L4 == 1 then
    L8 = "/usr/sbin/format_userdisk fs >/dev/null 2>/dev/null ;"
    L9 = L7
    L7 = L8 .. L9
  end
  L6.code = L5
  ...
  L8 = L6.code
  if L8 == 0 then
    L8 = L1.thrift_tunnel_to_smarthome_controller
    L9 = "{\"command\":\"reset_scenes\"}"
    L8(L9)
    L8 = L1.forkExec
    L9 = L7
    L8(L9)
...
function L4()
  ...
  L3 = L3(L4)
  L4 = {}
  L5 = L0.getWifiWpsStatus
  L5 = L5()
  if L5 == 2 then
    L6 = {}
    L7 = L0.getWpsConDevMac
    L7 = L7()
    if L7 then
      L8 = L0.isDeviceWifiConnect
      L9 = L7
      L10 = 1
      L8 = L8(L9, L10)
      if not L8 then
      ...
      if L10 then
        ...
        if L10 == false then
          ...
          L6.mac = L7
          L11 = L3.getDeviceCompany
          L12 = L7
          L11 = L11(L12)
          L6.company = L11
        end
      else
        L10 = _checkConnection
        L11 = L7
        L12 = 2
        L10 = L10(L11, L12)
        if L10 then
  ...
  ::lbl_122::
  if 3 <= L5 and L5 <= 7 then
    L5 = 3
  end
  L4.code = 0
  L4.status = L5
  L6 = L1.get
  L7 = L2.PREF_WPS_TIMESTAMP
  L8 = ""
  L6 = L6(L7, L8)
  L4.startTime = L6
  L6 = tostring
