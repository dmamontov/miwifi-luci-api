...
function L10()
  ...
  if L16 then
    ...
    L17 = 0
    L18 = _UPVALUE1_
    L18 = L18.KEY_GEL_INIT_APP
    L19 = 1
    L16(L17, L18, L19)
  end
  L16 = L1.ip_conflict_detection
  L16 = L16()
  if L16 then
    L17 = L1.ip_conflict_resolution
    L17()
  end
  L17 = L4.isStrNil
  L18 = L6
  ...
  if L17 == 0 then
    ...
    if L17 == 0 then
      ...
      L19 = string
      L19 = L19.format
      L20 = "/usr/sbin/mesh_connect.sh init_cap"
      L19, L20, L21, L22, L23, L24, L25, L26, L27 = L19(L20)
  ...
  if L17 ~= 0 then
    ...
    if L18 then
      ...
      L24 = L4._cmdformat
      L25 = L20
      L24, L25, L26, L27 = L24(L25)
      L22, L23, L24, L25, L26, L27 = L22(L23, L24, L25, L26, L27)
      L21(L22, L23, L24, L25, L26, L27)
    elseif L16 then
      L18 = L1.restart_services
      L19 = true
      L18(L19)
    else
      L18 = L4.forkRestartWifi
      L18()
    end
  end
  L17 = L4.getNetModeType
  L17 = L17()
  L5.workmode = L17
  L17 = _UPVALUE0_
  L17 = L17.write_json
...
function L10()
  ...
  if L25 == 0 and L7 then
    ...
    if L27 then
      ...
      L27.ssid = L7
      L27.ssid5G = L7
      L27.ip = "192.168.31.11"
      L27.conerrmsg = "for test"
      L25 = L27
    else
  ...
  if L25 ~= 0 then
    ...
    if L25 == 0 then
      ...
      if L26 then
        ...
        L32 = L4._cmdformat
        L33 = L28
        L32, L33, L34, L35, L36, L37, L38 = L32(L33)
        L30, L31, L32, L33, L34, L35, L36, L37, L38 = L30(L31, L32, L33, L34, L35, L36, L37, L38)
        L29(L30, L31, L32, L33, L34, L35, L36, L37, L38)
      else
...
function L10()
  ...
  if L26 == 0 and L8 then
    ...
    if L28 then
      ...
      L28.ssid = L8
      L28.ssid5G = L8
      L28.ip = "192.168.31.11"
      L28.conerrmsg = "for test"
      L26 = L28
    else
      L28 = _UPVALUE2_
      L29 = L28
  ...
  if L26 ~= 0 then
    ...
    if L26 == 0 then
      ...
      if L27 then
        ...
        L33 = L4._cmdformat
        L34 = L29
        L33, L34, L35, L36, L37, L38, L39 = L33(L34)
        L31, L32, L33, L34, L35, L36, L37, L38, L39 = L31(L32, L33, L34, L35, L36, L37, L38, L39)
  ...
  if L26 == 0 then
    ...
    L26(L27, L28, L29, L30, L31, L32, L33, L34, L35, L36, L37, L38, L39)
  end
...
function L10()
  ...
  L16 = L16.getNetMode
  L16 = L16()
  if L16 == "wifiapmode" then
    L5.code = 1618
  elseif L13 == 1 and L7 and L8 and L9 and L10 and L11 and L12 then
    L17 = _savePassword
    L18 = L10
    L19 = L12
    L20 = L11
...
function L10()
  ...
  if L2 then
    ...
    L4 = L4.isMeshCap
    L4 = L4()
    if L4 and L2 ~= L3 then
      L4 = luci
      L4 = L4.util
      L4 = L4.exec
      L5 = "mesh_cmd sync_lite > /dev/null 2>&1 &"
      L4(L5)
    end
  else
    L4 = _UPVALUE1_
