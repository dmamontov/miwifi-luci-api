...
function index()
    ...
    entry({"api", "xqsystem", "net_diagnose_start"}, call("netDiagnoseStart"), (""), 220)
    entry({"api", "xqsystem", "net_diagnose_result"}, call("netDiagnoseResult"), (""), 221)
end
...
function getInitInfo()
    ...
    result["model"]=XQConfigs.XQ_MODEL_PREFIX .. string.lower(result["hardware"] or "nil")
