  ...
  if L18 then
    ...
    if L8 == "native" then
      ...
      if L18 then
        ...
        if L18 then
          L18 = L2.forkExec
          L19 = "sleep 2; /etc/init.d/ipv6 native"
          L18(L19)
      end
      else
        L18 = L2.isStrNil
    ...
    elseif L8 == "nat" then
      ...
      if L18 then
        ...
        if L18 then
          L18 = L2.forkExec
          L19 = "sleep 2; /etc/init.d/ipv6 nat"
          L18(L19)
      end
      else
        L18 = L2.isStrNil
      ...
      if L11 ~= "static" then
        ...
        if L20 then
          ...
          if L20 then
            L20 = string
            L20 = L20.format
            L21 = "sleep 2; /etc/init.d/ipv6 static '%s' '%s' '%s' '%s'"
            L22 = L12
            L23 = L13
            L24 = L19
            L25 = L15
          ...
          if not L20 then
            ...
            if L20 then
              L20 = string
              L20 = L20.format
              L21 = "sleep 2; /etc/init.d/ipv6 static '%s' '%s' '%s' '%s' '%s'"
              L22 = L12
              L23 = L13
              L24 = L19
              L25 = L15
            ...
            if L20 then
              ...
              L20 = string
              L20 = L20.format
              L21 = "sleep 2; /etc/init.d/ipv6 static '%s' '%s' '%s' '%s' '%s','%s'"
              L22 = L12
              L23 = L13
              L24 = L19
              L25 = L15
    ...
    elseif L8 == "off" then
      L18 = L2.forkExec
      L19 = "sleep 2; /etc/init.d/ipv6 off"
      L18(L19)
    else
      L6 = 1606
    end
...
function L4()
  ...
  L6 = L6()
  if L6 then
    if L6 == "D01" or L6 == "RA72" or L6 == "RM1800" then
      L7 = L0.isMeshCap
      L7 = L7()
      if L7 then
        L7 = {}
