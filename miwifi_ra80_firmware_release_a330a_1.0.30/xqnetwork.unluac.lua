...
function L3()
  ...
  if L7 == 0 then
    ...
    L13 = L13()
    if L13 then
      L13 = "sh /sbin/whc_to_re_common_api.sh gw_update "
      L14 = L8
      L15 = "; sleep 3; reboot"
      L13 = L13 .. L14 .. L15
      L14 = logger
...
function L3()
  ...
  L18 = L18.formvalue
  L19 = "mtu"
  L18, L19, L20, L21, L22, L23, L24, L25, L26, L27, L28, L29, L30, L31, L32, L33, L34, L35, L36 = L18(L19)
  L17 = L17(L18, L19, L20, L21, L22, L23, L24, L25, L26, L27, L28, L29, L30, L31, L32, L33, L34, L35, L36)
  L18 = _UPVALUE0_
  L18 = L18.formvalue
  L19 = "service"
  L18 = L18(L19)
  ...
  elseif L7 == "pppoe" then
    if L6 == "web" then
      L21 = L0.check
      L22 = 0
      L23 = L0.KEY_VALUE_NETWORK_PPPOE
      L24 = 1
      L21(L22, L23, L24)
    end
    L21 = L2.isStrNil
    ...
    if L4 == 0 then
      ...
      L28 = L15
      L29 = L18
      L21 = L21(L22, L23, L24, L25, L26, L27, L28, L29)
      if not L21 then
        L4 = 1529
      end
    end
  ...
  elseif L7 == "static" then
    if L6 == "web" then
      L21 = L0.check
      L22 = 0
      L23 = L0.KEY_VALUE_NETWORK_STATIC
      L24 = 1
      L21(L22, L23, L24)
    end
    L21 = require
    L22 = "luci.cbi.datatypes"
    L21 = L21(L22)
    L22 = require
    L23 = "luci.ip"
    L22 = L22(L23)
        ...
        if not L23 then
          ...
          if L4 == 0 then
            ...
            if not L28 then
              ...
              L35 = L16
              L36 = L17
              L28 = L28(L29, L30, L31, L32, L33, L34, L35, L36)
              if not L28 then
                L4 = 1529
              else
              end
